...
1. Download and extract the `elastic-profiling` CLI, which will be provided in the private beta onboarding call. 
  [Sign-up for the private beta if you haven't.](https://docs.google.com/forms/d/e/1FAIpQLSd-SWVgvhO7Z_jAfaV9_bFGa0dUZPuX0JORzPGS8SDP7G-dVQ/viewform)
